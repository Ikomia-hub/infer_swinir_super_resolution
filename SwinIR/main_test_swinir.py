...
from infer_swinir_super_resolution.SwinIR.models.network_swinir import SwinIR as net
from infer_swinir_super_resolution.SwinIR.utils import util_calculate_psnr_ssim as util
